...
export default function BottleSpinGame() {
    ...
    return (
        <div className="game-body">
            ...
            <div className="canvas-area" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'flex-start', position: 'relative', overflowY: 'auto', paddingBottom: '40px' }}>

                {/* The circular player stage */}
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '350px', position: 'relative', width: '100%', maxWidth: '600px', margin: '0 auto', marginTop: '20px' }}>
                ...
                <div style={{ padding: '20px', width: '100%', maxWidth: '800px', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                    {!bsSpin ? (
                        ...
                        <h2 style={{ color: 'var(--text-muted)', marginBottom: 20 }}>🍾 Spinning...</h2>
                    )}
                </div>
            </div>
